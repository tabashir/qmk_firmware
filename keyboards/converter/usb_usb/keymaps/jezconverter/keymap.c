...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_LAYER_CHOOSER] = LAYOUT_fullsize_iso(
        TD(TD_ESC_ZERO) , TO(_QWERTY) , TO(_IMPACT) , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX            , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,
   ...
   [_IMPACT] = LAYOUT_fullsize_iso(
        ...
        KC_BTN1                  , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_6   , KC_7    , KC_8  , KC_9    , KC_0    , KC_MINS , KC_EQL  , KC_BSPC ,
        KC_INS                   , XXXXXXX , KC_5 ,
        KC_1                     , KC_2    , KC_3    , KC_4 ,
